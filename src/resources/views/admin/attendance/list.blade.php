    ...
    <div class="date-card">
        <table class="attendance-table">
            ...
            <tr>
                ...
                <td>
                    {{ floor($attendance->total_break / 3600) }}:{{ str_pad(floor(($attendance->total_break % 3600) /
                    60), 2, '0', STR_PAD_LEFT) }}
                </td>
                <td>
                    {{ floor($attendance->total_work / 3600) }}:{{ str_pad(floor(($attendance->total_work % 3600) / 60),
                    2, '0', STR_PAD_LEFT) }}
                </td>
                <td>
